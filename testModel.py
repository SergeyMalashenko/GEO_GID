...
def testModel( Model, dataFrame, targetColumn ):
	import warnings
...
def checkModel( Model, dataFrame ):
	import warnings
	warnings.filterwarnings('ignore')
...
if TARGET_COLUMN in inputDataFrame : 
	predictedData = testModel ( Model, inputDataFrame, TARGET_COLUMN )
else :
	predictedData = checkModel( Model, inputDataFrame )
